...
<html lang="en">
    ...
    <head>
        ...
        <title>Makweba's Food | Main</title>
    </head>
    ...
    <body>
        ...
        <header  id="main">
            ...
            <h1 style = "font-size:18px; letter-spacing:1.2px; font-style:italic;" class="purple">
                The Black Hacker is Cooking!!!!
            </h1>
            <form action="recipe.php">
                <input style = "font-size:11px;"type="submit" class="button show-recipe" value="Show recipe" name="show" id="show">
            </form>
